...
export default function Home() {
  return (
    <main className="flex-grow preserve-3d">
      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-white via-gray-50 to-white dark:from-navy dark:via-background-dark dark:to-navy py-24 md:py-40 isolate">
        ...
        <div className="relative z-20 max-w-6xl mx-auto px-6">
          <div className="flex flex-col gap-6 text-center items-center">
            <h1 className="text-navy dark:text-white text-5xl font-black leading-tight tracking-tighter md:text-7xl max-w-4xl animate-text-pop">
            ...
            <h2 className="font-body text-navy/80 dark:text-gray-300 text-base font-normal leading-normal md:text-xl max-w-2xl animate-text-pop [animation-delay:200ms]">
              The perfect dessert & beverage partner for your events, bringing sweet delights and refreshing sips to every occasion.
            </h2>
            <Link 
              to="/inquiry"
              className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-14 px-8 mt-6 bg-primary text-navy text-lg font-bold leading-normal tracking-[0.015em] hover:bg-accent transition-all duration-300 ease-in-out shadow-lg shadow-primary/40 hover:shadow-2xl hover:shadow-primary/50 hover:scale-110"
            >
      ...
      <section className="bg-background-light dark:bg-background-dark py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-navy dark:text-white">What We Offer</h2>
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-br from-primary/20 to-secondary/20 dark:from-navy/50 dark:to-primary/20 py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-navy dark:text-white mb-4">
            Ready to Add Sweetness to Your Event?
          </h2>
          <p className="text-lg text-navy/70 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            From intimate gatherings to grand celebrations, we bring the perfect dessert experience to your special day.
          </p>
          <Link 
            to="/inquiry"
            className="inline-flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-14 px-8 bg-primary text-navy text-lg font-bold leading-normal tracking-[0.015em] hover:bg-accent transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
          >
