          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 dark:text-gray-400">+91 800 322 5164</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-500 dark:text-gray-400">frostedfizzzz@gmail.com</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4 text-center lg:text-left">
              ...
              <div className="flex gap-4 justify-center lg:justify-start">
                ...
                <a href="https://www.instagram.com/frosted.fizz?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-gray-100 dark:bg-navy hover:bg-primary text-gray-600 dark:text-gray-300 hover:text-white flex items-center justify-center transition-all" aria-label="Instagram">
